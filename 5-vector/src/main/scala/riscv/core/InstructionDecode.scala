...
object InstructionTypes {
  ...
  val VectorLoad  = "b0000111".U(7.W)
  val VectorStore = "b0100111".U(7.W)
}
...
class InstructionDecode extends Module {
  ...
  val isVectorLoad  = opcode === InstructionTypes.VectorLoad
  val isVectorStore = opcode === InstructionTypes.VectorStore
  val usesRs1  = isLoad || isStore || isOpImm || isOp || isBranch || isJalr || isVectorLoad || isVectorStore
  val usesRs2  = isStore || isOp || isBranch
  val regWrite = isLoad || isOpImm || isOp || isLui || isAuipc || isJal || isJalr || isVectorLoad || isVectorStore
